...
const StoriesList = () => {
  const storyInfo = [
    ...
    ,
    {
      ...
      name: "Karolina",
      image:
        "https://res.cloudinary.com/practicaldev/image/fetch/s--4mfNEQ_X--/c_fill,f_auto,fl_progressive,h_320,q_auto,w_320/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/616404/2501bf53-b528-4223-ba4e-4776d7f743d3.jpeg",
    },
    ,
    {
      id: 5,
        ...
        return (
          <TouchableOpacity key={index}>
            <View style={styles.storiesContainer}>
              ...
              <View style={styles.storyElement}>
                <Image
                  source={{
                    uri: data.image,
                  }}
              ...
              <Text style={styles.storyText}>{data.name}</Text>
            </View>
          </TouchableOpacity>
        );
      })}
